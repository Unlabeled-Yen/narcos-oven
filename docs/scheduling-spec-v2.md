...
### 2.1 每品項時間公式（Yen 提供 + 我推導）

| 品項 | 1 爐 | 2 爐 (Δ) | 3 爐 (Δ) | 每爐容量 |
|---|---|---|---|---|
...
| 巴斯克類（各口味） | 2.0 h | 3.5 h* (+1.5) | 5.0 h* (+1.5) | 4 顆 |
| 香料堅果醬 | 2.0 h / 1000ml | — | — | 1000ml = 約 10×90ml 或 4×240ml |
...
## 10. 待 Yen review + confirm 事項

### 10.1 資料補充
- [ ] 蘋果 / 焦糖 / 磅蛋糕 / 巴斯克 的第 2、3 爐時間、我推導對嗎？
- [ ] 4 爐+ 時間延續斜率對嗎？還是會突然變慢？
- [ ] 巴斯克類是否**烤箱容量限制**（同時最多幾顆）？

### 10.2 語意 confirm
- [ ] batchDate = 週二為主、週三 fallback、對嗎？
- [ ] 賣貨便「指定出貨日」是**到貨日**還是**寄出日**？
- [ ] `wish_priority` 用 category 版預設可以嗎？特殊 SKU 要不要 override？
